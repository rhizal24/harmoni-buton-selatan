...
export const metadata: Metadata = {
  title: "Beranda",
  description:
    "Selamat datang di website resmi Desa Gayabaru, Buton Selatan.",
};
...
export default function HomePage() {
  return (
    <main>
      ...
      <section
        id="hero"
        aria-label="Selamat datang di Desa Gayabaru"
        className="hero-section"
      >
        <h1 className="hero-title">
          Selamat Datang di <span className="hero-accent">Desa Gayabaru</span>
        </h1>
        <p className="hero-subtitle">
          Buton Selatan, Sulawesi Tenggara — Membangun desa yang maju,
