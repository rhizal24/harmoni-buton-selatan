...
export function BeritaTerkini({
  ...
  return (
    <section
      id="berita-terkini"
      aria-label="Berita terkini Desa Gaya Baru"
              ...
              <div className="grid grid-cols-1 gap-3 lg:grid-cols-[minmax(0,7fr)_minmax(0,3fr)] lg:gap-8">
                ...
                >
                  {articles.map((artikel) => (
                    <button
                      ...
                      className="flex cursor-pointer items-center gap-3 font-body text-sm font-semibold text-on-surface-variant hover:text-[#31577F]"
                    >
                      <span
                        className="h-1.5 w-1.5 rounded-full bg-[#31577F]/50"
                        aria-hidden
                      />
                      {artikel.title}
                    </button>
                ...
                <label className="relative block w-full">
                  ...
                  <input
                    ...
                    className="min-h-11 w-full rounded-md border border-outline-variant bg-white py-2.5 pl-11 pr-4 font-body text-sm text-on-surface placeholder:text-on-surface-variant/70 motion-safe:transition-colors motion-safe:duration-200 focus:border-[#31577F] focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#31577F]"
                  />
                </label>
              </div>
              ...
              {q && (
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={() => ubahQuery("")}
                    className="cursor-pointer font-semibold text-[#31577F] hover:underline"
                  >
                    Hapus pencarian
                  </button>
                </p>
