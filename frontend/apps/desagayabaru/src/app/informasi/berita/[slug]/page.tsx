    ...
    <main>
      <article className="bg-white px-5 pb-16 pt-36 sm:px-8 lg:pb-24 lg:pt-40">
        <div className="mx-auto flex w-full max-w-[720px] flex-col gap-6">
          <Link
            href="/informasi"
            className="self-start font-body text-sm font-semibold text-[#31577F] no-underline hover:underline"
          >
          ...
          <header className="flex flex-col gap-3">
            ...
            <h1 className="font-body text-[clamp(1.9rem,4vw,2.75rem)] font-semibold leading-tight text-[#31577F]">
              {article.title}
            </h1>
            {article.excerpt && (
          ...
          {article.coverImageUrl && (
            <div className="group overflow-hidden rounded-xl border-[1.5px] border-[#31577F]">
              <img
