...
export function PetaHero() {
  ...
  return (
    <section
      aria-label="Pembuka halaman Peta Desa Gaya Baru"
    ...
    >
      <div className="mx-auto flex w-full max-w-[52rem] flex-col items-center gap-5 text-center">
        ...
        <motion.p
          ...
          className="max-w-[34rem] font-body text-base leading-relaxed text-[#31577F]/80 sm:text-lg"
        >
          Kenali wilayah Desa Gaya Baru lewat peta interaktif dan sebaran
