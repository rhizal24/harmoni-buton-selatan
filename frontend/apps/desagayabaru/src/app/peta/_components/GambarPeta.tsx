...
/**
 * GambarPeta, 2 peta statis (bukan interaktif): Peta Wisata Gaya Baru
              ...
              <figure className="flex flex-col gap-3 rounded-lg border border-outline-variant bg-white p-3">
                {item.src ? (
                  ...
                  <div className="flex aspect-[4/3] w-full flex-col items-center justify-center gap-2 rounded-md border-[1.5px] border-dashed border-outline-variant bg-surface-container-low">
                    ...
                    <p className="font-body text-sm font-semibold text-[#31577F]/50">
                      Peta belum diunggah
                    </p>
                  </div>
                )}
                <figcaption className="px-1.5 pb-1">
                  <p className="font-body text-base font-bold text-[#31577F]">
                    {item.judul}
                  </p>
                  <p className="mt-0.5 font-body text-sm text-[#31577F]/70">
                    {item.deskripsi}
                  </p>
                </figcaption>
              </figure>
