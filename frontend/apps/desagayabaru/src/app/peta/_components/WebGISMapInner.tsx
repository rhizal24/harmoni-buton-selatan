...
const WARNA_WISATA = "#31577F";
const WARNA_UMKM = "#D96F2F";
const WARNA_BATAS_WILAYAH = "#2E2E2E";
const WARNA_BATAS_DESA = "#31577F";
  ...
  const peta = (
    ...
    >
      <button
        ...
        className="absolute top-3 left-3 z-[1000] flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border-[1.5px] border-[#D0D0D0] bg-white/95 text-[#5A5A5A] shadow-sm motion-safe:transition-colors hover:border-[#31577F] hover:text-[#31577F]"
      >
        {isExpanded ? (
      ...
      <button
        ...
        className="absolute top-14 left-3 z-[1000] flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border-[1.5px] border-[#D0D0D0] bg-white/95 text-[#5A5A5A] shadow-sm motion-safe:transition-colors hover:border-[#31577F] hover:text-[#31577F]"
      >
      ...
      <div className="absolute top-3 right-3 z-[1000] flex flex-col items-end">
        ...
        <button
          ...
          className="flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border-[1.5px] border-[#D0D0D0] bg-white/95 text-[#5A5A5A] shadow-sm motion-safe:transition-colors hover:border-[#31577F] hover:text-[#31577F] sm:hidden"
        >
        ...
        >
          {batasDesa && (
            <FilterPill
              ...
              activeClassName="border-[#31577F] bg-[#31577F] text-white shadow-[0_0_14px_rgba(49,87,127,0.55)]"
          ...
          {umkm.length > 0 && (
            <FilterPill
              ...
              activeClassName="border-[#D96F2F] bg-[#D96F2F] text-white shadow-[0_0_14px_rgba(244,91,105,0.55)]"
        ...
        {tampilBatasDesa && batasDesa && (
          <GeoJSON
            ...
            onEachFeature={(feature, layer) => {
              const nama = feature.properties?.NAMOBJ ?? "Desa Gaya Baru";
                ...
                <div className="w-[240px] font-body">
                  ...
                  <div className="flex flex-col gap-1.5 px-3.5 py-3">
                    <div className="flex flex-col gap-0.5">
                      <p className="text-lg leading-tight font-bold text-[#31577F]">
                        {w.nama}
                      </p>
                      {w.tagline && (
                    ...
                    {w.tags.length > 0 && (
                      <div className="flex flex-wrap gap-1">
                        {w.tags.slice(0, 3).map((tag) => (
                          <span
                            key={tag}
                            className="rounded-full bg-[#D9E4F1] px-2 py-0.5 text-[10px] font-semibold text-[#1F3A59]"
                          >
                            {tag}
                          </span>
                        ))}
                    ...
                    <Link
                      ...
                      className="mt-1 text-xs font-semibold text-[#31577F] hover:underline"
                    >
                      Lihat detail →
                    </Link>
                  </div>
            ...
            >
              <Popup className="map-popup" minWidth={200} maxWidth={220}>
                <div className="flex w-[200px] flex-col gap-1.5 px-3.5 py-3 font-body">
                  <p className="text-sm font-bold text-[#D96F2F]">{u.nama}</p>
                  {(u.kategori || u.lokasi) && (
                  ...
                  <Link
                    ...
                    className="mt-1 text-xs font-semibold text-[#D96F2F] hover:underline"
                  >
                    Lihat UMKM desa →
                  </Link>
                </div>
