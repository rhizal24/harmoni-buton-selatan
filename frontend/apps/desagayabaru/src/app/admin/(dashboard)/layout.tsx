        ...
        <div className="absolute top-full z-20 mt-1 w-full overflow-hidden rounded-md border bg-popover py-1 shadow-floating">
          {hasil.length === 0 ? (
            ...
            hasil.map((item) => (
              ...
              >
                <item.icon className="size-4 text-[#31577F]" />
                {item.label}
              </button>
            ))
          )}
      ...
      <SidebarProvider style={{ "--sidebar-width": "17.5rem" } as React.CSSProperties}>
                ...
                <SidebarMenuButton size="lg" asChild>
                  <Link href="/admin">
                    ...
                    <div className="grid flex-1 text-left leading-tight">
                      <span className="truncate font-body text-base font-bold tracking-tight text-[#31577F]">
                        {SITE_NAME}
                      </span>
                      <span className="truncate font-body text-[11px] font-semibold uppercase tracking-[0.24em] text-[#31577F]/60">
                        Panel Admin
                      </span>
                    </div>
                  </Link>
          ...
          <SidebarContent>
            {NAV_GROUPS.map((group) => (
              <SidebarGroup key={group.label ?? "utama"}>
                {group.label && (
                  <SidebarGroupLabel className="font-body text-[11px] font-semibold uppercase tracking-[0.2em] text-[#31577F]/70">
                    {group.label}
                  </SidebarGroupLabel>
                )}
                <SidebarGroupContent>
        ...
        <SidebarInset className="bg-[#F7FAFB]">
          <header className="sticky top-0 z-10 flex h-16 shrink-0 items-center gap-2 border-b border-border bg-[#F7FAFB] px-4 lg:px-6">
            ...
            <h1 className="font-body text-base font-bold tracking-tight text-[#31577F]">
            ...
            <div className="ml-auto flex items-center gap-2.5">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    <span className="flex size-9 items-center justify-center rounded-full bg-[#31577F] font-body text-sm font-bold text-white">
