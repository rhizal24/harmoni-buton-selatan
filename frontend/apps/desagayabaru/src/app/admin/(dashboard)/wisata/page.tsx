    ...
    <div className="flex flex-col gap-6">
      ...
      >
        <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <p className="mt-0.5 font-body text-xs text-[#5A5A5A]">
              ...
              {guidebook ? (
                <a
                  ...
                  className="font-semibold text-[#31577F] underline"
                >
                  Lihat file saat ini
                </a>
              ) : (
          ...
          <label className="cursor-pointer rounded-md border border-[#31577F] px-4 py-2 font-body text-sm font-semibold text-[#31577F] hover:bg-[#D9E4F1]">
