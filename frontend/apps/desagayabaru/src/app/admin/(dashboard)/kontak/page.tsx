  ...
  return (
    <div className="flex flex-col gap-6">
      <header>
        ...
        <h1 className="mt-1 font-body text-2xl font-bold tracking-tight text-[#31577F]">
          Kontak Footer
        </h1>
      ...
      {sosmed && (
        ...
        >
          <h2 className="font-body text-base font-bold tracking-tight text-[#31577F]">
            Email &amp; Sosial Media
          </h2>
          ...
          <label className="flex flex-col gap-1.5">
            ...
            <input
              type="email"
              placeholder="desagayabaru@butonselatan.go.id"
              value={sosmed.email}
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_360px]">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex justify-end gap-2">
                      <button
                        ...
                        className="font-body text-xs font-semibold text-[#31577F] hover:underline"
                      >
                        Edit
                      </button>
                      <button
        ...
        >
          <div className="flex items-center justify-between">
            <h2 className="font-body text-sm font-bold tracking-tight text-[#31577F]">
          ...
          <button
            type="submit"
            disabled={busy}
            className="rounded-md bg-[#31577F] px-6 py-2.5 font-body text-sm font-semibold text-white hover:bg-[#27466A] disabled:opacity-60"
          >
