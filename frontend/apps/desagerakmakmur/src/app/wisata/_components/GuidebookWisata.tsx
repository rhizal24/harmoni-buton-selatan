 ...
 * Berkas: /docs/guidebook-wisata-gerakmakmur.pdf (stub — ganti berkas asli).
 */

const ISI_GUIDEBOOK = [
  "Peta & rute perjalanan menuju Desa Gerak Makmur",
...
export function GuidebookWisata({
  ...
  return (
    <section
      id="guidebook-wisata"
      aria-label="Guidebook wisata Desa Gerak Makmur"
    ...
    >
      <div className="mx-auto grid w-full max-w-[1112px] items-center gap-12 lg:grid-cols-[1fr_minmax(0,380px)] lg:gap-16">
        ...
        <div ref={leftRef} className="flex flex-col items-start gap-4">
          ...
          <h2 className="font-body text-[clamp(2rem,4vw,3rem)] font-semibold leading-tight text-[#006572]">
            Guidebook Wisata Gerak Makmur
          </h2>
          <p className="max-w-[46rem] font-body text-lg leading-relaxed text-[#006572]/80">
            ...
            perjalanan sampai tips menikmati Karamba bersama warga desa.
          ...
          <ul className="mt-2 flex flex-col gap-3">
            {ISI_GUIDEBOOK.map((item) => (
              ...
              >
                <span
                  className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#CFF1F4] text-[#006572]"
                  aria-hidden
                >
          ...
          <div className="mt-5 flex flex-wrap items-center gap-4">
            <a
              href={FILE_GUIDEBOOK}
              download
              className="inline-flex items-center gap-2.5 rounded-md bg-[#006572] px-8 py-3 font-body text-sm font-semibold text-white no-underline shadow-sm motion-safe:transition-[transform,filter] motion-safe:duration-300 motion-safe:ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-0.5 active:translate-y-0 hover:[filter:drop-shadow(0_0_16px_rgba(0,101,114,0.55))_drop-shadow(0_0_44px_rgba(0,101,114,0.30))] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#006572]"
            >
            ...
            <a
              href={`${WA_LINK}?text=${encodeURIComponent("Halo, saya mau bertanya soal wisata Desa Gerak Makmur")}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center rounded-md border-[1.5px] border-[#006572] px-8 py-3 font-body text-sm font-semibold text-[#006572] no-underline shadow-sm motion-safe:transition-transform motion-safe:duration-200 hover:-translate-y-0.5 active:translate-y-0 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#006572]"
            >
              Tanya via WhatsApp
            </a>
          </div>
        ...
        >
          <div className="relative aspect-[3/4] overflow-hidden rounded-lg border-[1.5px] border-[#006572] bg-gradient-to-br from-[#006572] via-[#02525c] to-[#00343c] p-7 shadow-sm motion-safe:transition-transform motion-safe:duration-300 motion-safe:ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:-translate-y-1.5">
