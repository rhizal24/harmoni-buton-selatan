...
import { WISATA } from "../_data/wisata";
...
export function DaftarWisata() {
  const [active, setActive] = useState(0); // Karamba Resto terbuka default
        ...
        <Reveal>
          <div className="flex flex-col items-start gap-4">
            ...
            <p className="max-w-[46rem] font-body text-lg leading-relaxed text-[#006572]/80">
              Empat destinasi unggulan Desa Gerak Makmur. Arahkan kursor untuk
