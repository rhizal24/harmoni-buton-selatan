...
const INPUT_CLASS =
  "w-full rounded-md border border-outline-variant bg-white px-3.5 py-2.5 font-body text-sm text-on-surface outline-none placeholder:text-on-surface-variant/60 motion-safe:transition-[border-color,box-shadow] focus:border-[#006572] focus:ring-2 focus:ring-[#006572]/15";
  ...
  return (
    <>
      <button
        ...
        className={`inline-flex min-h-11 cursor-pointer items-center rounded-md bg-[#006572] px-8 py-3 font-body text-sm font-semibold text-white shadow-sm hover:[filter:drop-shadow(0_0_16px_rgba(0,101,114,0.55))_drop-shadow(0_0_44px_rgba(0,101,114,0.30))] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#006572] ${BUTTON_MOTION}`}
      >
        Unggah Foto
      </button>
            ...
            >
              {done ? (
                ...
                <div className="flex flex-col items-center gap-4 py-4 text-center">
                  <span
                    className="flex h-14 w-14 items-center justify-center rounded-full bg-[#CFF1F4] text-[#006572]"
                    aria-hidden
                  >
                  ...
                  <h3 className="font-body text-xl font-bold text-[#006572]">
                    Terima kasih!
                  </h3>
                  <p className="font-body text-sm leading-relaxed text-on-surface-variant">
                    Fotomu sudah kami terima dan sedang menunggu verifikasi
                    admin. Setelah disetujui, foto akan tampil di Lensa Lande.
                  </p>
                  <button
                    type="button"
                    onClick={() => setOpen(false)}
                    className="mt-1 rounded-md bg-[#006572] px-6 py-2.5 font-body text-sm font-semibold text-white hover:bg-[#00525c] motion-safe:transition-colors"
                  >
                    Tutup
                  </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <button
                      ...
                      aria-label="Tutup"
                      onClick={() => setOpen(false)}
                      className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md text-on-surface-variant hover:bg-surface-container-low hover:text-[#006572] motion-safe:transition-colors"
                    >
                  ...
                  <button
                    ...
                    className="group relative flex min-h-44 w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg border-[1.5px] border-dashed border-outline-variant bg-surface-container-low hover:border-[#006572] hover:bg-[#CFF1F4]/25 motion-safe:transition-colors"
                  >
                    {preview ? (
                      <>
                      ...
                      <span className="flex flex-col items-center gap-3 p-6 text-center">
                        <span className="flex h-12 w-12 items-center justify-center rounded-full bg-[#CFF1F4] text-[#006572] group-hover:scale-105 motion-safe:transition-transform">
                        ...
                        <span className="font-body text-sm font-semibold text-on-surface group-hover:text-[#006572] motion-safe:transition-colors">
                  ...
                  <button
                    type="submit"
                    disabled={!file || busy}
                    className="min-h-11 w-full rounded-md bg-[#006572] px-6 py-3 font-body text-sm font-semibold text-white shadow-sm motion-safe:transition-[transform,filter] motion-safe:duration-300 motion-safe:ease-[cubic-bezier(0.22,1,0.36,1)] disabled:cursor-not-allowed disabled:opacity-40 enabled:hover:-translate-y-0.5 enabled:active:translate-y-0 enabled:hover:[filter:drop-shadow(0_0_16px_rgba(0,101,114,0.55))_drop-shadow(0_0_44px_rgba(0,101,114,0.30))]"
                  >
