...
const INPUT_CLASS =
  "w-full rounded-md border border-outline-variant px-3 py-2.5 font-body text-sm text-on-surface outline-none motion-safe:transition-colors focus:border-[#006572]";
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <button
                      ...
                      aria-label="Tutup"
                      onClick={() => setOpen(false)}
                      className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-outline-variant text-on-surface-variant hover:border-[#006572] hover:text-[#006572] motion-safe:transition-colors"
                    >
                  ...
                  <button
                    ...
                    className="group relative flex min-h-40 w-full items-center justify-center overflow-hidden rounded-md border-[1.5px] border-dashed border-outline-variant bg-surface-container-low hover:border-[#006572] motion-safe:transition-colors"
                  >
                    {preview ? (
                      ...
                      <span className="flex flex-col items-center gap-2 p-6 font-body text-sm text-on-surface-variant group-hover:text-[#006572] motion-safe:transition-colors">
                  ...
                  <button
                    type="submit"
                    disabled={!file || busy}
                    className="min-h-11 rounded-md bg-[#006572] px-6 py-3 font-body text-sm font-semibold text-white hover:bg-[#00525c] disabled:cursor-not-allowed disabled:opacity-40 motion-safe:transition-colors"
                  >
